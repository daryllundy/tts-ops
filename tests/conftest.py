...
mock_prometheus.Counter = lambda *_, **__: MagicMock()
mock_prometheus.Gauge = lambda *_, **__: MagicMock()
mock_prometheus.Histogram = lambda *_, **__: MagicMock()
mock_prometheus.Info = lambda *_, **__: MagicMock()
mock_prometheus.Summary = lambda *_, **__: MagicMock()
mock_prometheus.Enum = lambda *_, **__: MagicMock()
